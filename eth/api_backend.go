...
func (b *EthApiBackend) StateAndHeaderByNumber(ctx context.Context, blockNr rpc.BlockNumber) (vm.EthApiState, *types.Header, error) {
...
func (b *EthApiBackend) GetEVM(ctx context.Context, msg core.Message, state vm.EthApiState, header *types.Header, vmCfg vm.Config) (*vm.EVM, func() error, error) {
